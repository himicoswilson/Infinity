...
struct PhotoPreviewController<Page: View>: UIViewControllerRepresentable {
    var pages: [Page]
    ...
    class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        var parent: PhotoPreviewController<Page>
        var controllers = [UIViewController]()

        init(_ parent: PhotoPreviewController<Page>) {
            self.parent = parent
        ...
        // 实现 UIPageViewControllerDelegate 方法
